...
Public Class FrmMovimientoStock
    ...
    Private Sub cmdFinalizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdFinalizar.Click
        ...
        facMovStock.guardarMovimientoStock(vta, cmbSucursal.Text, Not FrmPrincipal.AcuseReciboToolStripMenuItem.Checked)
        If chkImprimir.Checked Then hiloSegundoPlano.RunWorkerAsync(vta)
        MessageBox.Show("Operación realizada correctamente " & vbCr & " ** CODIGO CRC **  " & vta.CalcularCodigoMovimiento, "Saturn 1.0", MessageBoxButtons.OK, MessageBoxIcon.Information)
        vta = New Venta
        ActualizarRenglones()
    ...
    Private Sub hiloSegundoPlano_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles hiloSegundoPlano.DoWork
        ...
        Impresora.imprimirTicketMovimiento(venta)
