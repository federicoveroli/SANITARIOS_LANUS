...
Public Class rptFacturaLegalA4_p_Imagen2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacturaLegalA4_p_Imagen2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturaLegalA4_p_Imagen2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturaLegalA4_p_Imagen2 = New rptFacturaLegalA4_p_Imagen2
        rpt.Site = Me.Site
        Return rpt
    End Function
