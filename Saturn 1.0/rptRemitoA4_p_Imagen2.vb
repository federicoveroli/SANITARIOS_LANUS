...
Public Class rptRemitoA4_p_Imagen2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRemitoA4_p_Imagen2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRemitoA4_p_Imagen2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRemitoA4_p_Imagen2 = New rptRemitoA4_p_Imagen2
        rpt.Site = Me.Site
        Return rpt
    End Function
