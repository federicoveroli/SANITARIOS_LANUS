...
Public Class FrmClienteBuscar
    ...
    Private Sub cmdBaja_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdBaja.Click
        ...
        If dt.Rows(0).Item(0) = 0 Then
            If MessageBox.Show("¿Realmente desea eliminar el cliente seleccionado?", "Confirme la operación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
